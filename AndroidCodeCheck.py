...
class apkAnalysis():
    ...
    def decompile_AndroidManifest(self, apkpath, outputpath):
        ...
        try:
            ...
            cmd = "java -jar lib/AXMLPrinter2.jar {}/AndroidManifest.xml > {}/AndroidManifest_resolved.xml".format(
    ...
    def fastScanEngine(self, task):
        ...
        apkname = \
        os.popen("lib/aapt2 dump badging %s |grep application-label:" % filepath).read().replace("\n", "").split(":")[
            1].replace("'", "")
